          ...
          <div className="flex">
            ...
            <div className="grid grid-4 form mainform">
              ...
              <FormikFormField
                  ...
                  help={<HelpField id="opsmx.terraformapply.AWSAccountName" />}
                  input={(props) => (
                    <ReactSelectInput
                    clearable={false}
              ...
              <div className="grid-span-2">
                <FormikFormField
                  ...
                  help={<HelpField id="opsmx.terraformapply.spinnakerNamespace" />}
              ...
              <div className="grid-span-2">
                <FormikFormField
                  ...
                  help={<HelpField id="opsmx.terraformapply.tfScriptRepo" />}
                  input={(props) => <TextInput {...props} />}
                />
              </div>             
              <div className="grid-span-2">

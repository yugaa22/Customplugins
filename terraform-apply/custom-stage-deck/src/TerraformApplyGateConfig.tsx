            ...
            <div className="grid grid-4 form mainform">
              <div className="grid-span-2">
                <FormikFormField
                  ...
                  help={<HelpField id="opsmx.customTSApplyJobStage.tfScriptAccount" />}
              ...
              <div className="grid-span-2">
                <FormikFormField
                  ...
                  help={<HelpField id="opsmx.customTSApplyJobStage.tfApplyScriptRepo" />}
                  input={(props) => <TextInput {...props} />}
                />
              </div>
              ...
              <div className="grid-span-2">
                <FormikFormField
                  ...
                  label="Tf Location"
                  help={<HelpField id="opsmx.customTSApplyJobStage.tfLocation" />}
                  input={(props) => <TextInput {...props} />}
                />
              </div>
              <div className="grid-span-2">
                <FormikFormField
                  ...
                  label="Override File"
                  help={<HelpField id="opsmx.customTSApplyJobStage.overrideFile" />}
                  input={(props) => <TextInput {...props} />}
                />
              </div>
              <div className="grid-span-2">
                <FormikFormField
                  ...
                  help={<HelpField id="opsmx.customTSApplyJobStage.tfStateAccount" />}
                  input={(props) => <TextInput {...props} />}
                />
              </div>
              <div className="grid-span-2">
                <FormikFormField
                  ...
                  label="Artifact Repo"
                  help={<HelpField id="opsmx.customTSApplyJobStage.artifactRepo" />}
                  input={(props) => <TextInput {...props} />}
                />
              </div>
              <div className="grid-span-2">
                <FormikFormField
                  ...
                  label="Artifact UUID"
                  help={<HelpField id="opsmx.customTSApplyJobStage.artifactUUID" />}
                  input={(props) => <TextInput {...props} />}
                />
              </div>
            </div>

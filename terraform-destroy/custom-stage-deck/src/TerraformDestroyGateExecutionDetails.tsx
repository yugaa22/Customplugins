 ...
 */
export function TerraformDestroyGateExecutionDetails(props: IExecutionDetailsSectionProps) {
  const getClasses = () => {
    let classes = '';
...
export namespace TerraformDestroyGateExecutionDetails {
  export const title = 'Terraform Destroy';
}

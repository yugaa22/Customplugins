...
export const initialize = () => {
  ...
  HelpContentsRegistry.register('opsmx.verification.logTemplate', 'Please enter Log Template Name');
  HelpContentsRegistry.register('opsmx.verification.metricTemplate', 'Please enter the Metric Template Name');
  HelpContentsRegistry.register('opsmx.verification.environment', 'Please enter the Environment');
};
